...
//  lcd__print_screen(5, 6, screens, rowCount, prevRowCount);
...
//        lcd__clear_screen();
    ...
    if (displayScreen == 4)
    {
      if(prevDisplayScreen != displayScreen || prevRowCount != rowCount)
      {
        prevDisplayScreen = displayScreen;
        prevRowCount = rowCount;
        lcd__clear_screen();
      }
      lcd__menu(rowCount, prevRowCount);
    }
  }
}
